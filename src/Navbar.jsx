...
export default function Navbar() {
    ...
    return (
        // Navigation Bar
        <nav className="fixed w-full navbar-bg shadow-md z-50">
            <div className="container mx-auto px-6 py-4">
                <div className="flex items-center justify-between">
                    <div className="flex items-center">
                        <img src={portfolioImg} alt="portfolio" className="h-10 w-10 rounded-full md:hidden" />
                        <div className="hidden md:block text-2xl font-bold text-indigo-500">M.Khalil</div>
                    </div>
